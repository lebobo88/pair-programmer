...
8. If the new verdict passes, finalize the stage as passed and the run as complete (calling `master-plan-patcher` first). If it fails again, finalize the stage as `surfaced`.
