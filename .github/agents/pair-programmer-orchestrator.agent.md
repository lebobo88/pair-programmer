...
- `.github/skills/pair-programmer/SKILL.md` — master lifecycle + delegation contract for harness flows
- `.github/commands/pp/*.md` — the canonical behavior for each `/pp:*` command
...
3. Read the matching command file from `.github/commands/pp/`.
4. For `run`, `best-of`, `team`, `review`, `retry`, and `gate`, also read `.github/skills/pair-programmer/SKILL.md` first and obey it.
