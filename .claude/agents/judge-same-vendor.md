...
- **claude**: generator `claude-opus-4-8` → judge `claude-sonnet-4-6`; generator `claude-sonnet-4-6` → `claude-opus-4-8`; generator `claude-haiku-4-5-20251001` → `claude-sonnet-4-6`.
