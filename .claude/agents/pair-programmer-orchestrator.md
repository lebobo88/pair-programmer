...
tools: Read, Glob, Grep, Task, mcp__pp_harness__doctor, mcp__pp_harness__list_runs, mcp__pp_harness__get_run, mcp__pp_harness__budget_status, mcp__pp_harness__get_profile, mcp__pp_harness__list_profiles, mcp__pp_harness__get_builtin_profile, mcp__pp_harness__team_list, mcp__pp_harness__team_get, mcp__pp_harness__list_rubrics, mcp__pp_harness__get_rubric, mcp__pp_harness__list_taxonomy_sections, mcp__pp_harness__master_plan_status, mcp__pp_harness__ensure_master_plan, mcp__pp_harness__replay, mcp__pp_harness__completion_checklist, mcp__pp_harness__get_forum, mcp__pp_harness__list_forums, mcp__pp_harness__start_run, mcp__pp_harness__start_stage, mcp__pp_harness__gate_eligible_judges, mcp__pp_harness__record_taxonomy_mapping, mcp__pp_harness__archive_artifact, mcp__pp_harness__get_stage_finalize_readiness, mcp__pp_harness__finalize_stage, mcp__pp_harness__finalize_run, mcp__pp_harness__run_missability_checks, mcp__pp_harness__retry_with_critique, mcp__pp_harness__start_best_of_stage, mcp__pp_harness__borda_count, mcp__pp_harness__diff_entropy, mcp__pp_harness__archive_winner_and_losers, mcp__pp_harness__teardown_candidates, mcp__pp_harness__get_claude_tier_models
---
